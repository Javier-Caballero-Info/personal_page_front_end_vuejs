module.exports = `
  ...
  <b-form @submit="onSubmit">
    ...
    <b-card class="mb-2">
      <h1 class="text-center mb-0" v-show="!errors.has('name')"> {{socialNetwork.name}} </h1>
    </b-card>
    <b-card class="mb-2">
      ...
      <div class="row">
        ...
        <div class="col-sm-5 col-md-6 text-center mt-4">
          <b-img-lazy :src="socialNetwork.img" thumbnail rounded alt="Fluid image" class="mx-auto" style=""  v-show="!errors.has('img')"/>
        </div>
